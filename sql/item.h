...
/* If item may be null */
#define ITEM_FLAG_MAYBE_NULL  (1<<0)
...
public:
  ...
  */
  ...
  inline void copy_flags(Item *org, item_flags_t mask)
  {
    flags= (flags & ~mask) | (org->flags & mask);
  }
  ...
  */
  ...
  inline decimal_part_t decimal_int_part() const
  { return (decimal_part_t) my_decimal_int_part(decimal_precision(), decimals); }
  /*
  ...
  */
  decimal_part_t decimal_scale() const
  {
  ...
  */
  ...
  bool has_subquery() const { DBUG_ASSERT(fixed()); return with_subquery(); }
...
public:
  ...
  Item_fixed_hybrid(THD *thd, Item_fixed_hybrid *item)
   :Item(thd, item)
  {
    flags|= item->flags & ITEM_FLAG_FIXED;
  }
...
public:
  ...
  void fix_char_length(size_t max_char_length_arg)
  {}
  void set_join_tab_idx(uint8 join_tab_idx_arg)
  { DBUG_ASSERT(0); }
};
...
public:
  ...
  */
  ...
  {
    collation= DTCollation_numeric();
    decimals= (decimal_part_t) dec_arg;
    cached_time= *ltime;
  }
